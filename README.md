...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,eclipse,vscode,java,mysql,py,git,linux,aws,gcp,docker,kubernetes,jenkins,ansible,terraform,grafana&perline=6	)](https://skillicons.dev)
